...
- - be sure to generalize working directories and paths to code that is nested within another directory
- Add a simple test example that users must run to verify everything is installed and working as expected
- Add a slightly more detailed example to illustrate how the main function call (active learning with entropy acquisition) works
- 
